...
# ================= CONFIG =================
INT_FILE = Path(r"C:\Users\User\Desktop\combined PHA front csv\average_PHA no bg substract.csv")
PHA_FILE = Path(r"C:\Users\User\Desktop\combined average INT front bg substracted\average_INT front bg substracted.csv")

OUTPUT_CSV = Path(r"C:\Users\User\Desktop\Free beam size plot\plot.csv")
