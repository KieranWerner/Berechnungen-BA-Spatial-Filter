...
INTENSITY_VARIANTS = [
    {
        "name": "int_raw",
        "path": Path(r"C:\Users\User\Desktop\average INT front csv background substracted\average_INT.csv"),
    },
    {
        "name": "int_corrected",
...
BASE_OUTPUT_DIR = Path(r"C:\Users\User\Desktop\extended_parameter_optimization2")
