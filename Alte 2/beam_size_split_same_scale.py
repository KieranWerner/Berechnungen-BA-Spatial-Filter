...
# GLOBAL Y SCALE
# =========================
all_values = df.drop(columns=["z_cm"]).values.flatten()
...
plt.savefig(os.path.join(FOLDER, "beam_size_d4sigma_same_scale.png"), dpi=150)
...
plt.savefig(os.path.join(FOLDER, "beam_size_other_same_scale.png"), dpi=150)
