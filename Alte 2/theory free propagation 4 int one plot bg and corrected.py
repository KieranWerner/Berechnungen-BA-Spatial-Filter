...
for int_path, pha_path, label in FILE_PAIRS:
    ...
    scale = scale_metrics["D4sigma_mm"] / 1e3  # zurück in Pixel bei dx=1
...
# --------------------------------------------------
# EIN PLOT: ALLE SIZE-DEFINITIONEN
# --------------------------------------------------
...
plt.title("Propagation (4 files, WITH phase) - all size definitions")
