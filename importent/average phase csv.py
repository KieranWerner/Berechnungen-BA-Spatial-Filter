...
INPUT_FOLDER = Path(r"C:\Users\User\Desktop\average PHA front csv single background substracted")
FILE_PATTERNS = ["PHA*.csv"]

OUTPUT_CSV = Path(r"C:\Users\User\Desktop\combined average PHA front single bg substracted\average.csv")
