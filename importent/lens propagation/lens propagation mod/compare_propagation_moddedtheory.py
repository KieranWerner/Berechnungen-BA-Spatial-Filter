...
CFG = {
    ...
    "REAL_CSV": "real_lens_propagation.csv",
    "THEORY_CSV": "theory_lens_propagation_opt_all_except_defocus.csv",
    "OUTPUT_PNG": "comparison_lens_propagation_moddedtheory.png",
}
