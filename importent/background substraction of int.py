...
# EINSTELLUNGEN
# ============================================================
INPUT_FOLDER = Path(r"C:\Users\User\Desktop\average INT front csv")
BACKGROUND_FILE = Path(r"C:\Users\User\Desktop\average INT front csv background substracted\average_background_PHA front.csv")
OUTPUT_FOLDER = Path(r"C:\Users\User\Desktop\average INT front csv background substracted")

FILE_PATTERNS = ["INT*.csv", "*.csv"]
